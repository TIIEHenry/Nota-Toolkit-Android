package nota.android.widget.loadingview
...
class LoadingView : View {
        ...
        a?.indexCount?.let {
            for (i in 0 until it) {
                when (val attr = a.getIndex(i)) {
                    ...
                    R.styleable.LoadingView_lvStrokeWidth -> mStrokeWidth = a.getDimension(attr, TypedValue.applyDimension(
                    ...
                    R.styleable.LoadingView_lvCirclePadding -> mCirclePadding = a.getDimension(attr, TypedValue.applyDimension(
    ...
    private fun drawLoading(canvas: Canvas?) {
        ...
        for (i in 0 until mCount) {
            val rectF = RectF(
                mCircleX - mRadius + i * mCirclePadding,
                mCircleY - mRadius + i * mCirclePadding,
                mCircleX + mRadius - i * mCirclePadding,
                mCircleY + mRadius - i * mCirclePadding
            )
