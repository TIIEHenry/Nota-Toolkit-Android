package tiiehenry.android.view.flowtag;
...
import tiiehenry.android.view.flowtag.adapter.BaseTagAdapter;
import tiiehenry.android.view.flowtag.adapter.SimpleTagAdapter;
...
public class FlowTagLayout extends ViewGroup {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        if (entriesID != 0) {
            BaseTagAdapter tagAdapter = setItems(context.getResources().getStringArray(entriesID));
            int selectedIDs = typedArray.getResourceId(R.styleable.FlowTagLayout_ftl_selecteds, 0);
            if (selectedIDs != 0) {
                tagAdapter.setSelectedPositions(context.getResources().getIntArray(selectedIDs));
            }
        }
        typedArray.recycle();
    }
    ...
    private int mDefaultWidth = Integer.MAX_VALUE;
    private int mDefaultHeight = Integer.MAX_VALUE;

    public int getDefaultWidth() {
        return mDefaultWidth;
    }

    public void setDefaultWidth(int maxWidth) {
        mDefaultWidth = maxWidth;
    }
    ...
    public void setDefaultHeight(int maxHeight) {
        mDefaultHeight = maxHeight;
    }
    ...
    public <T> BaseTagAdapter setItems(@NonNull List<T> items) {
        if (mAdapter != null) {
            ...
            BaseTagAdapter tagAdapter = new SimpleTagAdapter(getContext());
