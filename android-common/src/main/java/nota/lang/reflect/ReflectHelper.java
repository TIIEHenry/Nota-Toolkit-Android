...
/**
 * 带有cache实现的ReflectHelper
 */
public class ReflectHelper {

    private static final String TAG = "ReflectHelper";

    public static Class<?> getClassObject(String className) throws ClassNotFoundException {
        return ReflectionCache.build().forName(className);
    }
    ...
    public static Object invokeStatic(String className, String methodName, Class<?>[] paramsTypes, Object... params) throws Exception {
        ...
        return invokeStatic(objClass, methodName, paramsTypes, params);
    }

    public static Object invokeStatic(Class<?> objClass, String methodName) throws Exception {
        return invoke(objClass, null, methodName, new Class[]{});
    }

    public static Object invokeStatic(Class<?> objClass, String methodName, Class<?>[] paramsTypes, Object... params) throws Exception {
    ...
    public static Object invoke(Object target, String methodName) throws Exception {
        return invoke(target, methodName, new Object[]{});
    }
    ...
    public static Object invoke(Class<?> objClass, Object target, String methodName, Class<?>[] paramsTypes, Object... params) throws Exception {
        if (params == null || params.length == 0) {
            Method method = ReflectionCache.build().getDeclaredMethod(objClass, methodName);
            method.setAccessible(true);
            return method.invoke(target);
     ...
     * @return 是否存在
     */
    public static boolean touchMethod(String className, String methodName, Class<?>... parameterTypes) {
        try {
            ReflectionCache.build().forName(className).getMethod(methodName, parameterTypes);
            return true;
